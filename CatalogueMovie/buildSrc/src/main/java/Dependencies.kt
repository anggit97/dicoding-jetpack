...
object ApplicationId {
    const val id = "com.anggit97.cataloguemovie"
}
...
object Testing{
    ...
    const val mockitoAndroid = "org.mockito:mockito-android:${Version.mockitoCore}"
    ...
    const val mockitoHemcrest = "org.hamcrest:hamcrest-all:${Version.hemcrest}"
    const val archLifecycle = "androidx.arch.core:core-testing:${Version.lifecycleTest}"

    const val rules = "androidx.test:rules:${Version.androidxTest}"
    const val runner = "androidx.test:runner:${Version.androidxTest}"
    const val ext = "androidx.test.ext:junit:${Version.androidxTestVersion}"
    const val core = "androidx.test:core:${Version.androidxTestVersion}"
