...
object FakeDataTesting {
    ...
    fun generateMovies(): ArrayList<ResultMovieEntity> {
        val resultMovies: ArrayList<ResultMovieEntity> = arrayListOf()
    ...
    fun generateTvShow(): ArrayList<ResultMovieEntity> {
        val resultMovies: ArrayList<ResultMovieEntity> = arrayListOf()
        ...
        resultMovies.add(
            ResultMovieEntity(
                "/gNQA76kl251IuJVKMHfrRE12p7j.jpg",
                3,
        ...
        resultMovies.add(
            ResultMovieEntity(
                "/eEiCGxRMhU1pAZj03GmnjtVGEiR.jpg",
                11,
