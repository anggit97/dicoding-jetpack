...
class ViewModelFactory private constructor(private val mAcademyRepository: AcademyRepository) :
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        ...
        when {
            modelClass.isAssignableFrom(AcademyViewModel::class.java) -> return AcademyViewModel(mAcademyRepository) as T
            modelClass.isAssignableFrom(DetailCourseViewModel::class.java) -> return DetailCourseViewModel(mAcademyRepository) as T
            modelClass.isAssignableFrom(BookmarkViewModel::class.java) -> return BookmarkViewModel(mAcademyRepository) as T
            modelClass.isAssignableFrom(CourseReaderViewModel::class.java) -> return CourseReaderViewModel(mAcademyRepository) as T
