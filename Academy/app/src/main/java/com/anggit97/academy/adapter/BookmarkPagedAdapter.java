...
/**
 * Created by Anggit Prayogo on 2019-09-10.
 * Github : @anggit97
 */
public class BookmarkPagedAdapter extends PagedListAdapter<CourseEntity, BookmarkPagedAdapter.BookmarkViewHolder> {
    ...
    public BookmarkPagedAdapter(BookmarkFragmentCallback callback) {
        super(DIFF_CALLBACK);
    ...
    public CourseEntity getItemById(int swipedPosition) {
