...
object FakeDataDummy {
    ...
    fun generateDummyModules(courseId: String): ArrayList<ModuleEntity> {
        ...
        modules.add(
            ModuleEntity(
                moduleId = String.format("%sm1", courseId),
                courseId = courseId,
                title = "Modul 0 : Introduction",
                position = 0,
                read = null
            )
        )
        modules.add(
            ModuleEntity(
                moduleId = String.format("%sm2", courseId),
                courseId = courseId,
                title = "Modul 1 : Teori 1",
                position = 1,
                read = null
            )
        )
        modules.add(
            ModuleEntity(
                moduleId = String.format("%sm3", courseId),
                courseId = courseId,
                title = "Latihan 1",
                position = 2,
                read = null
        ...
        modules.add(
            ModuleEntity(
                moduleId = String.format("%sm4", courseId),
                courseId = courseId,
                title = "Bedah Kode 1",
                position = 3,
                read = null
        ...
        modules.add(
            ModuleEntity(
                moduleId = String.format("%sm5", courseId),
                courseId = courseId,
                title = "Modul 2 : Teori 2",
                position = 4,
                read = null
            )
        )
        ...
        modules.add(
            ModuleEntity(
                moduleId = String.format("%sm6", courseId),
                courseId = courseId,
                title = "Latihan 2",
                position = 5,
                read = null
        ...
        modules.add(
            ModuleEntity(
                moduleId = String.format("%sm7", courseId),
                courseId = courseId,
                title = "Bedah Kode 2",
                position = 6,
                read = null
